...
class TestVehicle:
    ...
    def test_valid_number_plate(self, car):
        vehicle = models.Vehicle(vehicle_type=car, passengers=2, number_plate="AA-12-34")
        assert vehicle.validate_number_plate()

        number_plates = ["AA-BB-34", "12-34-56", "AA1234", "AA 12 34"]
        for number_plate in number_plates:
            vehicle = models.Vehicle(vehicle_type=car, passengers=2, number_plate=number_plate)
